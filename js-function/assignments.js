...
function publicBusFare(totalPeople) {
    ...
    if (isNaN(totalPeople) == true) {
        ...
        if (totalPeople >= busCapacity) {
            ...
            if (restOFThePeople >= microbusCapacity) {
                ...
                if (peopleInPublic > 0) {
                    ...
                    return "Bus: " + busNeed + ", MicroBus: " + microbusNeed + ", Local Transport: " + peopleInPublic + " Person, cost : " + giveLocalRent;

                }
                else {
                    return "Bus: " + busNeed + ", MicroBus: " + microbusNeed;
                }
            }
        }
        //OtherWise totalPeople is equal or larger than microbusCapacity.
            ...
            if (peopleInPublic > 0) {
                let giveLocalRent = peopleInPublic * perpersonLocalRent;
                return "MicroBus: " + microbusNeed + ", Local Transport: " + peopleInPublic + " Person, cost : " + giveLocalRent;

            }
            else {
                return "MicroBus: " + microbusNeed;
            }
        }
        // if less than microbus Capacity
        else {
            let giveLocalRent = totalPeople * perpersonLocalRent;
            return totalPeople + " Person, cost : " + giveLocalRent;
        }
    }
